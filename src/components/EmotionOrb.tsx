...
export const EmotionOrb: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      if (lerpAlpha < 1) {
        ...
        // Interpolate
        currentColor
          .copy(emotionColors[currentIndexRef.current])
          .lerp(emotionColors[nextIndexRef.current], alpha);
  ...
  }, []); // containerRef is a stable ref, no need to include in deps
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[140%] h-[140%] pointer-events-none">
        ...
        >
          <div
            className="bg-black/60 backdrop-blur-md border-r-2 p-4 rounded-l-lg"
            style={{ borderColor: 'var(--active-color)' }}
          >
            <h4 className="text-[10px] font-mono tracking-widest text-gray-400 mb-1">
              REWARD PROTOCOL
            </h4>
        ...
        >
          <div
            className="bg-black/60 backdrop-blur-md border-l-2 p-4 rounded-r-lg"
            style={{ borderColor: 'var(--active-color)' }}
          >
            <h4 className="text-[10px] font-mono tracking-widest text-gray-400 mb-1">
              SYSTEM LATENCY
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-mono font-bold text-white">
                20<span className="text-xs text-gray-500">ms</span>
              </span>
            </div>
          </div>
        </motion.div>
