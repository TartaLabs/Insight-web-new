  ...
  >
    ...
    <div className="bg-surface border border-white/10 p-6 rounded-xl mb-12 text-sm text-gray-400">
      ...
      <p>
        ...
        or “our”), a company registered in Hong Kong SAR.
      </p>
      <div className="mt-4 pt-4 border-t border-white/5">
        <p>
          Welcome to Insight (“Insight”, “the App”, or “the Service”). Insight is available on{' '}
          <strong>iOS, Android, and Web</strong>, enabling users to label emotional data,
          participate in AI model testing, and earn on-chain reward tokens.
        </p>
        <p className="mt-2">
          By creating an account or using Insight on any platform, you agree to these Terms of Use &
    ...
    <div className="space-y-12 text-gray-300 leading-relaxed">
      ...
      <section>
        ...
        <div className="pl-4 md:pl-11">
          ...
          <ul className="list-disc pl-5 space-y-1 text-gray-400 mb-4">
            <li>
              You have the legal capacity to enter into this agreement under the laws of your
              region; <strong>or</strong>
            </li>
            <li>
              If you are a minor, your parent or legal guardian has reviewed and accepted these
              Terms and allows your use (where required by local law).
            </li>
          </ul>
          <p className="mb-2">By using Insight, you represent that:</p>
          <ul className="list-disc pl-5 space-y-1 text-gray-400">
            <li>
              Your use does not violate local laws or platform rules (including Apple App Store /
              Google Play policies);
            </li>
            <li>
              You are not subject to any sanctions or restrictions that prohibit use of the Service.
            </li>
          </ul>
        </div>
      </section>
        ...
        <div className="pl-4 md:pl-11 space-y-6">
          ...
          <div>
            <h3 className="text-lg font-bold text-white mb-2">
              2.1 Emotion Data Collection & Labeling
            </h3>
            <p className="text-gray-400">
              Upload images or selfies and select corresponding emotion labels (Happy, Anger, Sad,
          ...
          <div>
            ...
            <p className="text-gray-400">
              Participate in tasks that improve our multi-modal emotion recognition model.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-bold text-white mb-2">2.3 On-Chain Reward System</h3>
            <p className="mb-2">
              Insight uses <strong>non-transferable</strong> blockchain reward tokens:
            </p>
            <ul className="list-disc pl-5 space-y-1 text-gray-400">
              <li>
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Subscriptions differ across platforms depending on purchase method. We may modify or
      ...
      <section>
        ...
        <div className="pl-4 md:pl-11 space-y-6">
          ...
          <div>
            ...
            <p className="mb-2">
              Web users use a <strong>separate account system</strong> with:
            </p>
            <ul className="list-disc pl-5 space-y-1 text-gray-400 mb-2">
              <li>Metamask</li>
              <li>OKX Wallet</li>
            ...
            <p className="text-gray-300 mb-1">
              Rewards are issued on <strong>Mantle chain</strong>.
            </p>
            <p className="text-gray-300 font-bold">
              Mobile and Web accounts are not currently linked.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-400">
              Report unauthorized access to{' '}
              <span className="text-white">official@tartalabs.io</span>.
            </p>
          </div>
          <div>
      ...
      <section>
        ...
        <div className="pl-4 md:pl-11 space-y-6">
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1 text-gray-400 mb-2">
              <li>
                <strong>iOS (Apple)</strong> → Apple In-App Purchase (fiat)
              </li>
              <li>
                <strong>Android (Google Play)</strong> → Google Play Billing (fiat)
              </li>
              <li>
                <strong>Web</strong> → On-chain crypto payments on Mantle (wallet transfer)
              </li>
            </ul>
            <p className="text-gray-400">
              We do <strong>not</strong> support third-party payment channels.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-bold text-white mb-2">
              4.2 Auto-Renewing Subscriptions (iOS & Android)
            </h3>
          ...
          <div>
            <h3 className="text-lg font-bold text-white mb-2">
              4.3 Managing & Canceling Subscriptions
            </h3>
            <ul className="list-disc pl-5 space-y-1 text-gray-400">
              <li>
                <strong>iOS:</strong> Apple ID → Subscriptions
              </li>
              <li>
                <strong>Android:</strong> Google Play → Payments & subscriptions
              </li>
              <li>
                <strong>Web:</strong> Wallet-based billing panel
              </li>
            </ul>
          </div>
          <div>
            ...
            <p className="mb-2">
              Purchases are generally non-refundable except where required by law or Apple/Google
              policy.
            </p>
      ...
      <section>
        ...
        <div className="pl-4 md:pl-11 space-y-6">
          <div>
            ...
            <p className="mb-2">
              Insight rewards users with <strong>non-transferable participation tokens</strong>:
            </p>
            <ul className="list-disc pl-5 space-y-1 text-gray-400 mb-2">
              <li>
          ...
          <div>
            ...
            <p className="mb-1">
              Insight does <strong>not</strong> provide:
            </p>
            <ul className="list-disc pl-5 space-y-1 text-gray-400">
          ...
          <div>
            ...
            <p className="mb-1">
              We may optionally introduce programs referencing your token balance, but:
            </p>
            <ul className="list-disc pl-5 space-y-1 text-gray-400">
              <li>
                They are <strong>not guaranteed</strong>
              </li>
      ...
      <section>
        ...
        <div className="pl-4 md:pl-11">
          ...
          <p className="text-white">
            Personal data is handled per the <strong>Insight Privacy Policy</strong>.
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="pl-4 md:pl-11">
          <p className="text-gray-400 mb-2">
            All IP related to Insight—including the AI models, code, design, content, text, and
            trademarks—belongs to Tarta Tech Limited.
          </p>
          <p className="text-gray-400">
            You receive a <strong>personal, non-exclusive, non-transferable license</strong> to use
            the App.
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="pl-4 md:pl-11">
          ...
          <ul className="list-disc pl-5 space-y-1 text-gray-400 mb-4">
            <li>
              <strong>Not</strong> a medical or psychological diagnostic tool
            </li>
            <li>
              <strong>Not</strong> financial or investment advice
            </li>
            <li>
              Provided <strong>AS IS</strong> without warranties
            </li>
          </ul>
      ...
      <section>
        ...
        <div className="pl-4 md:pl-11">
          ...
          <ul className="list-disc pl-5 space-y-1 text-gray-400 mb-2">
            ...
            <li>
              Our total liability shall not exceed <strong>USD $50</strong>
            </li>
          </ul>
      ...
      <section>
        ...
        <div className="pl-4 md:pl-11">
          <p className="mb-1">
            You confirm you are <strong>not</strong>:
          </p>
          <ul className="list-disc pl-5 space-y-1 text-gray-400 mb-2">
      ...
      <section>
        ...
        <div className="pl-4 md:pl-11">
          ...
          <p className="text-gray-400">
            We are not responsible for third-party service failures or behavior.
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="pl-4 md:pl-11">
          <p className="text-gray-400 mb-2">
            These Terms are governed by <strong>Hong Kong SAR law</strong>.
          </p>
          <p className="text-gray-400">
            Disputes will be submitted to the courts of Hong Kong SAR unless local law requires
            otherwise.
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="pl-4 md:pl-11">
          ...
          <p className="text-gray-400">
            Using the App after changes means you accept the updated Terms.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white/5 border border-white/10 p-8 rounded-xl">
        ...
        <div className="pl-0 md:pl-4 space-y-6">
          <p className="text-sm text-gray-400 italic mb-4">
            This section applies only to iOS users.
          </p>

          <div>
            <h3 className="text-lg font-bold text-white mb-2">
              16.1 Agreement with Tarta, Not Apple
            </h3>
            <p className="text-gray-400">
              This EULA is between you and Tarta Tech Limited only. Apple is not responsible for
              Insight.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-400">
              You receive a non-transferable license to use Insight on Apple devices, per the Apple
          ...
          <div>
            ...
            <p className="text-gray-400">
              Tarta Tech Limited, not Apple, is responsible for support and maintenance.
            </p>
          </div>
          <div>
          ...
          <div>
            <h3 className="text-lg font-bold text-white mb-2">
              16.7 Export & Sanctions Compliance
            </h3>
            <p className="text-gray-400">
              You confirm you are not in a sanctioned region or on any prohibited list.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-400">
              ...
              Hong Kong SAR
              <br />
              Email: <strong className="text-white">official@tartalabs.io</strong>
            </p>
          </div>
          <div>
            <h3 className="text-lg font-bold text-white mb-2">16.9 Third-Party Terms</h3>
            <p className="text-gray-400">
              You must comply with the terms of your wireless provider and other third-party
              agreements.
            </p>
          </div>
          <div>
