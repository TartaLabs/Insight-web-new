...
import { Zap, Shield, Sparkles, Calendar, X, Cpu, Smartphone, Terminal } from 'lucide-react';
import { SectionWrapper } from './SectionWrapper';

// industries array removed as it was unused
...
const CodeTyper: React.FC<CodeTyperProps> = ({ typed, cursorVisible }) => (
...
export const EmotionalSDK: React.FC = () => {
  ...
  // CodeTyper component moved outside to avoid re-creation on render
    ...
    <SectionWrapper className="relative overflow-hidden bg-gradient-to-b from-[#06090f] via-[#05070d] to-[#04060a]">
      ...
      <div className="relative z-10 container mx-auto px-6 space-y-10">
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 xl:gap-16 items-start min-h-[60vh]">
          <div className="space-y-5">
            <div className="inline-flex items-center gap-2 px-3 py-1 border border-white/10 rounded-full bg-white/5 backdrop-blur">
              ...
              <span className="text-[11px] font-mono tracking-[0.2em] text-gray-300">
                DEVELOPERS
              </span>
            </div>
            <h2 className="text-4xl md:text-5xl font-extrabold text-white brightness-110 tracking-tight leading-tight">
              Build with the{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-tech-blue via-white to-purple-400">
                Emotional SDK
              </span>
            </h2>
            <p className="text-gray-300 text-lg leading-relaxed max-w-2xl">
              Empower your Flutter apps with human-level emotional intelligence. Runs fully
              on-device with ~20ms real-time inference, keeping user data private while detecting 7
              emotions locally.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Seamless for iOS & Android with a single codebase.',
                },
                {
                  icon: Shield,
                  title: 'On-Device AI',
                  desc: 'Privacy-first. No video leaves the device.',
                },
                {
                  icon: Zap,
                  title: '20ms Latency',
                  desc: 'Optimized pipeline for interactive use cases.',
                },
                {
                  icon: Sparkles,
                  title: '7 Emotions',
                  desc: 'Happy, Anger, Sad, Fear, Disgust, Surprise, Neutral.',
                },
              ].map((item, idx) => (
                <motion.div
                  key={item.title}
          ...
          <div className="w-full">
            <div className="bg-[#0c111a] border border-white/10 rounded-2xl shadow-[0_25px_50px_rgba(0,0,0,0.45)] overflow-hidden min-h-[260px]">
              ...
              <div className="p-5 font-mono text-[12px] leading-6 text-gray-200 bg-gradient-to-br from-[#0a0d14] via-[#0b121c] to-[#05070c] whitespace-pre relative">
                ...
                />
                <CodeTyper typed={typed} cursorVisible={cursorVisible} />
              </div>
        ...
        <div className="space-y-8 pt-10 md:pt-14 border-t border-white/10">
          <h3 className="text-2xl font-extrabold text-white brightness-110">
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center px-4">
          <div className="w-full max-w-lg bg-[#0c0f16] border border-white/10 rounded-lg p-6 relative shadow-[0_20px_50px_rgba(0,0,0,0.45)]">
            ...
            <p className="text-sm text-gray-400 mb-4">
              Tell us about your app and we will reach out within 1 business day.
            </p>
