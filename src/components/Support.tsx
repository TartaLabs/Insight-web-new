      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
            <a
              href="#"
              className="bg-surface border border-white/10 p-6 rounded-xl hover:border-tech-blue/50 transition-colors group"
            >
              ...
              <p className="text-sm text-gray-400">
                Join our server for real-time support from mods and the community.
              </p>
            </a>
            <a
              href="#"
            ...
            >
              ...
              <p className="text-sm text-gray-400">
                For account-specific issues or business inquiries.
              </p>
            </a>
            <a
              href="#"
            ...
            >
              ...
              <p className="text-sm text-gray-400">
                Read the detailed guides on how to label data efficiently.
              </p>
            </a>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-white/5 rounded-lg p-6">
                ...
                <p className="text-gray-400 text-sm">
                  Tokens are distributed via the Mantle network. Please ensure your EOA wallet
                  (MetaMask) is connected to the Mantle Mainnet. Transactions can take up to 2
                  minutes to index.
                </p>
              </div>
              ...
              <div className="bg-white/5 rounded-lg p-6">
                ...
                <p className="text-gray-400 text-sm">
                  No. $aEMO and $mEMO are Soulbound Tokens (SBTs) tied to your contribution history.
                  They cannot be sent to other wallets.
                </p>
              </div>

              <div className="bg-white/5 rounded-lg p-6">
                <h3 className="font-bold text-white mb-2">
                  My photo was rejected during audit. Why?
                </h3>
                <p className="text-gray-400 text-sm">
                  Common reasons include: poor lighting, face not fully visible, or the expression
                  does not match the selected emotion label. Please review the Data Specs guide.
                </p>
              </div>
            </div>
          </div>
