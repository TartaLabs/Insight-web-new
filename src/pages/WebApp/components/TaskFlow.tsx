...
export const TaskFlow: React.FC<TaskFlowProps> = ({
  ...
  const [isStaged, setIsStaged] = useState<boolean | null>(
    initialTask?.draftData?.isStaged ?? null,
  );
          ...
          {currentStep === 'example' && (
            <div className="flex flex-col items-center text-center max-w-md z-10">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed">
                ...
                <span className="text-tech-blue font-bold">{emotion.toUpperCase()}</span>. Ensure
                optimal lighting conditions.
              </p>
              <Button onClick={handleStartCapture} className="mt-2">
                Activate Camera
              </Button>
            </div>
          )}
            ...
            <div className="w-full max-w-md z-10 space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <Button
                    variant={isClear === true ? 'primary' : 'ghost'}
                    className="flex-1"
                  ...
                  <Button
                    variant={isClear === false ? 'primary' : 'ghost'}
                    className="flex-1"
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <Button
                    variant={isStaged === false ? 'primary' : 'ghost'}
                    className="flex-1"
                  ...
                  <Button
                    variant={isStaged === true ? 'primary' : 'ghost'}
                    className="flex-1"
