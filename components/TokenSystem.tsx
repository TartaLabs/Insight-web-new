    ...
    <div className="w-full container mx-auto px-6 lg:px-8 xl:px-10">
      <div className="flex flex-col items-center mb-12">
        ...
        <p className="text-tech-gray text-center max-w-4xl text-base md:text-lg leading-relaxed mx-auto">
          A unified incentive layer. Earn <span className="text-blue-400">$bEMO</span> on BNB Chain via Mobile, or <span className="text-tech-blue">$mEMO</span> on Mantle via Web. Both serve as your soulbound proof of contribution to Emotion AI.
        </p>
      </div>
