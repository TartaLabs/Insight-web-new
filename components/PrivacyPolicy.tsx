...
export const PrivacyPolicyContent: React.FC = () => (
  ...
  >
    ...
    <div className="bg-surface border border-white/10 p-6 rounded-xl mb-12 text-sm text-gray-400">
       ...
       <p><strong className="text-white">Operator:</strong> Tarta Tech Limited (“Tarta”, “we”, “us”, “our”), registered in Hong Kong SAR.</p>
       <div className="mt-4 pt-4 border-t border-white/5">
          <p>This Privacy Policy explains how we collect, use, store, and protect your information when you use Insight on <strong>iOS, Android, or Web</strong>. Your use of Insight signifies your acceptance of this Policy.</p>
       </div>
    </div>
    ...
    <div className="space-y-12 text-gray-300 leading-relaxed">
      ...
      <section>
        <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
          <span className="flex items-center justify-center w-8 h-8 rounded-full bg-tech-blue/10 text-tech-blue text-sm">1</span>
        ...
        <div className="space-y-6 pl-4 md:pl-11">
          ...
          <div>
             <h3 className="text-lg font-bold text-white mb-2">1.2 Facial Image Data (Voluntarily Provided)</h3>
             ...
             <p className="mt-2 text-sm text-gray-500 italic">You provide this content voluntarily, and you may choose not to upload facial images.</p>
          </div>
          ...
          <div>
             ...
             <p className="mt-2 text-sm text-gray-500">We use standard analytics and diagnostic tools.</p>
          </div>
          ...
          <div>
             ...
             <div className="space-y-4">
                ...
                <div>
                   ...
                   <p className="text-gray-400 text-sm mb-2">You log in using your blockchain wallet on Mantle (e.g., Metamask or OKX). We collect:</p>
                ...
                <div className="bg-red-500/10 border border-red-500/20 p-4 rounded-lg">
                   <h4 className="text-red-400 text-xs font-bold uppercase tracking-wider mb-2">Important Note</h4>
      ...
      <section>
         <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
           <span className="flex items-center justify-center w-8 h-8 rounded-full bg-tech-blue/10 text-tech-blue text-sm">2</span>
      ...
      <section>
         <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
           <span className="flex items-center justify-center w-8 h-8 rounded-full bg-tech-blue/10 text-tech-blue text-sm">3</span>
           Data Retention
         </h2>
         <div className="pl-4 md:pl-11">
            <ul className="list-disc pl-5 space-y-2 text-gray-400">
               <li>Uploaded photos and labeling data may be retained for AI research or model improvement.</li>
      ...
      <section>
         <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
           <span className="flex items-center justify-center w-8 h-8 rounded-full bg-tech-blue/10 text-tech-blue text-sm">4</span>
           Data Sharing
         </h2>
         <div className="pl-4 md:pl-11 space-y-6">
            ...
            <div>
               <h3 className="text-lg font-bold text-white mb-2">4.2 Research & Development Partners</h3>
               <p className="text-gray-400">Only <strong>anonymized</strong> or <strong>aggregated</strong> datasets may be shared.</p>
            </div>
            <div>
               ...
               <p className="mt-2 text-white font-bold">We never sell data to advertisers or brokers.</p>
            </div>
         </div>
      </section>
      ...
      <section>
         <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
           <span className="flex items-center justify-center w-8 h-8 rounded-full bg-tech-blue/10 text-tech-blue text-sm">5</span>
      ...
      <section>
         <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
           <span className="flex items-center justify-center w-8 h-8 rounded-full bg-tech-blue/10 text-tech-blue text-sm">6</span>
           Blockchain-Specific Disclosures
         </h2>
         <div className="pl-4 md:pl-11">
            <ul className="list-disc pl-5 space-y-2 text-gray-400 mb-4">
               <li>Public blockchains store wallet addresses and certain on-chain records permanently.</li>
            ...
            <p className="text-white italic">Your use of Insight signifies acceptance of blockchain transparency requirements.</p>
         </div>
      </section>
       ...
       <section>
         <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
           <span className="flex items-center justify-center w-8 h-8 rounded-full bg-tech-blue/10 text-tech-blue text-sm">7</span>
           Your Rights
         </h2>
         <div className="pl-4 md:pl-11">
            ...
            <div className="bg-white/5 p-4 rounded border border-white/10">
               <p className="mb-2"><strong>Contact:</strong> <span className="text-tech-blue">official@tartalabs.io</span></p>
               <p className="text-sm text-gray-400">Account deletion happens inside the app (mobile) or via instructions provided for Web users.</p>
            </div>
         </div>
      </section>
      ...
      <section>
         <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
           <span className="flex items-center justify-center w-8 h-8 rounded-full bg-tech-blue/10 text-tech-blue text-sm">8</span>
           Children’s Privacy
         </h2>
         <div className="pl-4 md:pl-11 text-gray-400">
            <p className="mb-2">Insight is <strong>not intended for children under the legal minimum age</strong> in your region.</p>
            <p>We do not knowingly collect data from children without legal guardian consent when required.</p>
         </div>
      </section>
      ...
      <section>
         <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
           <span className="flex items-center justify-center w-8 h-8 rounded-full bg-tech-blue/10 text-tech-blue text-sm">9</span>
           Data Security
         </h2>
         <div className="pl-4 md:pl-11">
            ...
            <p className="text-gray-400">No method of transmission is 100% secure, but we take all reasonable steps to protect your data.</p>
         </div>
      </section>
      ...
      <section>
         <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
           <span className="flex items-center justify-center w-8 h-8 rounded-full bg-tech-blue/10 text-tech-blue text-sm">10</span>
      ...
      <section>
         <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
           <span className="flex items-center justify-center w-8 h-8 rounded-full bg-tech-blue/10 text-tech-blue text-sm">11</span>
           Changes to This Policy
         </h2>
         <div className="pl-4 md:pl-11 text-gray-400">
            <p className="mb-2">We may update this Privacy Policy to reflect product or regulatory changes.</p>
      ...
      <section>
         <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
           <span className="flex items-center justify-center w-8 h-8 rounded-full bg-tech-blue/10 text-tech-blue text-sm">12</span>
           Contact Us
         </h2>
         <div className="pl-4 md:pl-11">
            ...
            <div className="bg-surface border border-white/10 p-6 rounded-xl">
               ...
               <p className="text-gray-400">Please include the subject line: <strong className="text-white">“Privacy Inquiry — Insight”</strong></p>
            </div>
         </div>
      </section>
